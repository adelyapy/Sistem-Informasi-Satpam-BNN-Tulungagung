                ...
                <form class="row g-3 align-items-end" method="get">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="shift" class="form-select">
                            ...
                            <?php mysqli_data_seek($daftarShift, 0); while ($shift = mysqli_fetch_assoc($daftarShift)): ?>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light"><tr><th>No</th><th>Tanggal</th><th>Satpam</th><th>Shift</th><th>Status</th><th class="text-center">Aksi</th></tr></thead>
                        <tbody>
                        <?php if (mysqli_num_rows($jadwal) > 0): $no=1; while ($row = mysqli_fetch_assoc($jadwal)): ?>
                            <tr>
                                <td><?= $no++ ?></td>
                        ...
                        <?php endwhile; else: ?>
                            <tr><td colspan="6" class="text-center text-muted py-5"><i class="bi bi-calendar-x fs-2 d-block mb-2"></i>Belum ada jadwal yang sesuai.</td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
