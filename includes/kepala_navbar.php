...
$namaProfil = $_SESSION['nama'] ?? 'Kepala BNN';
$pageTitle = $pageTitle ?? '';
...
<nav class="navbar navbar-satpam shadow-sm">
  <div class="container-fluid px-3 px-lg-4">
    <button class="btn btn-menu-toggle" type="button" id="sidebarToggle" aria-label="Buka menu navigasi" aria-controls="sidebar" aria-expanded="false"><i class="bi bi-list"></i></button>
    <?php if ($pageTitle !== ''): ?>
    ...
    <div class="navbar-profile d-flex align-items-center">
      <div class="profile-avatar"><i class="bi bi-person-fill"></i></div><span class="profile-name"><?= htmlspecialchars($namaProfil) ?></span>
    </div>
  </div>
</nav>
