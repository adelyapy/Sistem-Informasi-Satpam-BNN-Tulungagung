...
<main class="main-content">
  <div class="inventaris-page">
        ...
        <div class="inventory-table table-responsive">
          <table class="table align-middle">
            ...
            <tbody>
              <?php if (!$inventaris) { ?>
                <tr>
                  <td colspan="5" class="text-center text-muted py-5">Belum ada inventaris yang ditambahkan.</td>
                </tr>
              <?php } ?>
    ...
    <div class="d-flex flex-wrap justify-content-center gap-3 mt-4">
      ...
      <a class="btn btn-inventaris-primary" href="detail.php?id=<?= $idLaporan ?>"><i class="bi bi-floppy me-2"></i>Simpan Draft &amp; Lihat Rekap</a>
...
<?php if ($laporan['status'] === 'draft') {
  foreach ($inventaris as $row) { ?>
    <div class="modal fade" id="edit<?= (int) $row['id_inventaris'] ?>" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form method="post">
            <div class="modal-header">
              <h5 class="modal-title">Edit Inventaris</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
